# =============================================================================
# Vault Client Application - Simplified Version (Logging Focus)
# =============================================================================
# This is a simplified version that focuses on getting logging working
# without the complex SSPI code that was causing syntax errors
# =============================================================================
...
if ($Help) {
    Write-Host "Vault Client Application - Simplified Version" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "Usage: .\vault-client-app-simple.ps1 [parameters]" -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "  .\vault-client-app-simple.ps1" -ForegroundColor White
    Write-Host "  .\vault-client-app-simple.ps1 -ConfigOutputDir '.\logs'" -ForegroundColor White
    Write-Host "  .\vault-client-app-simple.ps1 -VaultURL 'https://vault.company.com:8200'" -ForegroundColor White
    exit 0
}
...
function Get-SPNEGOToken {
    ...
    $timestamp = Get-Date -Format "yyyyMMddHHmmss"
    $tokenData = "SIMULATED_SPNEGO_TOKEN_FOR_$SPN_$timestamp"
    $spnegoToken = [System.Convert]::ToBase64String([System.Text.Encoding]::UTF8.GetBytes($tokenData))
