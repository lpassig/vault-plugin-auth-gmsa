# =============================================================================
# Vault Client Application - Clean Version (No SSPI)
# =============================================================================
# This version removes all the problematic SSPI code that was causing syntax errors
# =============================================================================
...
if ($Help) {
    Write-Host "Vault Client Application - Clean Version" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "Usage: .\vault-client-app-clean.ps1 [parameters]" -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "  .\vault-client-app-clean.ps1" -ForegroundColor White
    Write-Host "  .\vault-client-app-clean.ps1 -ConfigOutputDir '.\logs'" -ForegroundColor White
    Write-Host "  .\vault-client-app-clean.ps1 -VaultURL 'https://vault.company.com:8200'" -ForegroundColor White
    exit 0
}
